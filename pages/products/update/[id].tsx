...
const Detail: NextPageWithLayout = () => {
    ...
    useEffect(() => {
        const getProductInfo = () => {
            return axios.post(fnCurrentApiUrl(`/api/products/${id}`))
        }
        if(!_.isNil(id)){
    ...
    const handleProductSubmit = async () => {
        ...
        handleImageUpload.then(() => {
            dispatch(allActions.products.product_temporary_status(''))
            setSubmit(true)
    ...
    return (
        <div>
            <Head>
                <title>{intl.formatMessage({id: 'LANGUAGE.EDIT'})}: {lang === "vi" ? product?.name?.vi : product?.name?.en}</title>
                <meta name="description"
                      content={`${intl.formatMessage({id: 'LANGUAGE.EDIT'})}: ${lang === "vi" ? product?.name?.vi : product?.name?.en}`}/>
            ...
            {product.product_id ? <>
                <div className="card card-flush">
                    <div className="card-body">
                        ...
                        <div className="row mb-5">
                            ...
                            <div className={'col col-sm col-lg-3 product_info'}>
                ...
                <div className="card card-flush mt-5">
                    <div className="card-body">
                        ...
                        <ProductVariantBlock defaultVariations={product.variations} defaultVariationsGroup={product.variation_groups} />
                    </div>
                </div>
                <div className="card card-flush mt-5">
                    <div className="card-body">
                    ...
                    <Button id="kt_horizontal_search_advanced_link" className="btn btn-link btn-sm" onClick={() => {
