        ...
        <Search />
            ...
            <div className={clsx('d-flex align-items-center', toolbarButtonMarginClass)}>
                ...
                >
                    ...
                    />
                    {showDot && <span
                        className="bullet bullet-dot bg-danger h-6px w-6px position-absolute translate-middle top-0 start-50 animation-blink"></span>}
                </div>
                <HeaderNotificationsMenu setDot={setShowDot}/>
            </div>
            ...
            >
                <div
                    className={clsx('cursor-pointer symbol btn btn-icon btn-active-light-primary', toolbarUserAvatarHeightClass)}
                    data-kt-menu-trigger='click'
                    data-kt-menu-attach='parent'
                    data-kt-menu-placement='bottom-end'
                    data-kt-menu-flip='bottom'
                >
                    <KTSVG
                        path='/media/icons/duotune/general/user.svg'
                        className={"svg-icon-1"}
                        svgClassName={"mh-40px"}
                    />
