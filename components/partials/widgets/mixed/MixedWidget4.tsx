          ...
          <div className='d-flex align-items-center'>
            ...
            <div className='symbol symbol-60px me-5'>
              <span className={clsx(`symbol-label`, `bg-${color}-light`)}>
                <Image src={toAbsoluteUrl(image)} className='h-50 align-self-center' alt='' layout='fill'/>
              </span>
            </div>
            {/* end:Image */}
        ...
        <div className='d-flex flex-column mt-10'>
          ...
          <div className='d-flex'>
            <a
              ...
              title='Ana Stone'
            >
              <Image src={toAbsoluteUrl('/media/avatars/150-1.jpg')} alt='' layout='fill'/>
            </a>
            ...
            <a
              ...
              title='Sam Harris'
            >
              <Image src={toAbsoluteUrl('/media/avatars/150-8.jpg')} alt='' layout='fill' />
            </a>
