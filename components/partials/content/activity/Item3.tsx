        ...
        <div className='mb-5 pe-3'>
          ...
          <div className='d-flex align-items-center mt-1 fs-6'>
            ...
            <div
              ...
              title='Jan Hummer'
            >
              <Image src={toAbsoluteUrl('/media/avatars/150-6.jpg')} alt='img' layout='fill'/>
            </div>
          </div>
        </div>
        ...
        <div className='overflow-auto pb-5'>
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5'>
            <div className='d-flex flex-aligns-center pe-10 pe-lg-20'>
              <Image alt='' className='w-30px me-3' src={toAbsoluteUrl('/media/svg/files/pdf.svg')} layout='fill'/>
            ...
            <div className='d-flex flex-aligns-center pe-10 pe-lg-20'>
              <Image alt='' className='w-30px me-3' src={toAbsoluteUrl('/media/svg/files/doc.svg')} layout='fill'/>
            ...
            <div className='d-flex flex-aligns-center'>
              <Image alt='' className='w-30px me-3' src={toAbsoluteUrl('/media/svg/files/css.svg')} layout='fill'/>
