        ...
        <div className='pe-3 mb-5'>
          ...
          <div className='d-flex align-items-center mt-1 fs-6'>
            ...
            <div
              ...
              title='Nina Nilson'
            >
              <Image src={toAbsoluteUrl('/media/avatars/150-11.jpg')} alt='img' layout='fill'/>
            </div>
          </div>
        </div>
        ...
        <div className='overflow-auto pb-5'>
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5'>
            ...
            <div className='symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2'>
              <div className='symbol symbol-circle symbol-25px'>
                <Image src={toAbsoluteUrl('/media/avatars/150-3.jpg')} alt='img' layout='fill'/>
              </div>
          ...
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0'>
            ...
            <div className='symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px'>
              <div className='symbol symbol-circle symbol-25px'>
                <Image src={toAbsoluteUrl('/media/avatars/150-5.jpg')} alt='img' layout='fill'/>
              </div>
