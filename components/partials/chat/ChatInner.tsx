...
import {defaultMessages, defaultUserInfos, messageFromClient, MessageModel, UserInfoModel} from "../../../utils/objectAlert";
                  ...
                  {message.type === 'in' ? (
                    <>
                      <div className='symbol  symbol-35px symbol-circle '>
                        <Image alt='Pic' src={toAbsoluteUrl(`/media/${userInfo.avatar}`)} layout='fill'/>
                      </div>
                      <div className='ms-3'>
                        <a
                          href='#'
